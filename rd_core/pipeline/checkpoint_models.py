...
Позволяет сохранять прогресс обра��отки и восстанавливать его после паузы.
"""
...
class OCRCheckpoint:
    ...
    - Восста��авливать обработку после паузы
    - Пропус��ать уже обработанные элементы
    """

    job_id: str
    phase: str  # "pass1", "pass2", "verification", "completed"

    # Обр��ботанные блоки (block_id)
    ...
    def apply_to_blocks(self, blocks: List) -> int:
        ...
        Returns:
            Количество блоков с восс��ановленными результатами
        """
        applied = 0
...
def get_checkpoint_path(work_dir: Path) -> Path:
    """Получить путь к файл�� checkpoint"""
